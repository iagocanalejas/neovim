...
-- Custom mappings
map("n", "J", "mzJ`z", { desc = "Removes line break" })
map("x", "<leader>p", [["_dP]], { desc = "Paste without clipboard update" })  -- greatest remap ever
map("i", "<C-c>", "<Esc>")  -- This is going to get me cancelled
